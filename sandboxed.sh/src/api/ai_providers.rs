...
/// Google/Gemini OAuth constants.
///
/// These values must be provided through environment variables in deployments
/// that need Google OAuth. They are intentionally not hardcoded in this repo.
