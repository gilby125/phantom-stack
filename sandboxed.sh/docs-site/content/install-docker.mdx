...
description: Run Open Agent locally or on a server using Docker Compose
---
...
To enable isolated container workspaces, uncomment the privileged settings in the repo-root `docker-compose.yml`:
