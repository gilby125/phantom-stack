...
export class EvolutionEngine {
	...
	constructor(configOrPath?: string | EvolutionConfig, useLLMJudges = false) {
		this.config =
			typeof configOrPath === "string" || typeof configOrPath === "undefined"
				? loadEvolutionConfig(configOrPath)
				: configOrPath;
